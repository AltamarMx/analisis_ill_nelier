...
aulas = ["A40-1","A40-2"]
for aula in aulas:
    os.system("rfluxmtx < ../modelo/objects/{}.pts -I+ -v -ab 10 -ad 65536 -dj 1 -dp 1 -dt 0 -dc 1 -as 2048 -lw 1e-6 -n 2 - ../modelo/skies/dc_sky_noground.rad ../modelo/materiales.rad ../modelo/{}.rad > ../modelo/matrices/dc_day.mtx".format(aula,aula))
